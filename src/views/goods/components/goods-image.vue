<template>
  <div class="goods-image">
    <div class="large" v-show="show" :style="[{ backgroundImage: `url(${picture[currIndex]})` }, bgPosition]"></div>
    <div class="middle" ref="target">
      <img :src="picture[currIndex]" alt="">
      <div class="layer" v-show="show" :style="position"></div>
    </div>
    <ul class="small">
      <li v-for="(img, i) in picture" :key="i" @mouseenter="currIndex = i" :class="{ active: i === currIndex }">
        <img :src="img" alt="">
      </li>
    </ul>
  </div>
